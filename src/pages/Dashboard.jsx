                        ...
                        <div className='flex flex-row max-w-full w-full gap-x-8 justify-between'>
                            <div className='flex flex-col gap-y-5 w-full justify-center items-center bg-white p-4 px-6 rounded-lg'>
                                ...
                                <div className='flex flex-col w-full'>
                                    ...
                                    <DashOrderCard trackingNo={'#876364'} imgSrc={camera} productName={'Camera Lens'} price={'$178'} orders={325} totalPrice={'$1,46,660'}></DashOrderCard>
                                    <DashOrderCard trackingNo={'#876945'} imgSrc={dress} productName={'Black Sleep dress'} price={'$14'} orders={53} totalPrice={'$46,660'}></DashOrderCard>
                                    <DashOrderCard trackingNo={'#872364'} imgSrc={oil} productName={'Argan Oil'} price={'$21'} orders={78} totalPrice={'$3,46,676'}></DashOrderCard>
                                    <DashOrderCard trackingNo={'#824317'} imgSrc={perfume} productName={'EAU DE Perfume'} price={'$32'} orders={98} totalPrice={'$3,46,981'}></DashOrderCard>
                                </div>
                            </div>
                            <div className='flex flex-col gap-y-5 min-w-[35%] w-fit  items-center bg-white p-4 px-6 rounded-lg'>
                                ...
                                <div className='w-full'>
                                    <DashSellingCard productName={'NIKE Shoes Black Pattern'} rating={'4.5'} price={'$85'} imgSrc={shoe} />
                                    <hr className='my-[22px]'></hr>
                                    <DashSellingCard productName={'iPhone 12'} rating={'4.3'} price={'$985'} imgSrc={mobile} />
                                </div>
                            </div>
                        </div>
